...
class _SearchDomainPageState extends State<SearchDomainPage> with TickerProviderStateMixin {
  ...
  Widget _buildSearchingLayout() {
    return Text("ABC");
    // TODO Build Other Result Page
//    return SearchOtherResultPage("领域", searchText);
  }
