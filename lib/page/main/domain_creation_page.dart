...
class DomainCreationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (model.mode == DomainState.modify) {
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text(tr("aggregate")),
                                  HEmptyView(5),
                                  Text(model.aggDomains.length.toString()),
                                  Text("/"),
                                  Text(model.aggDomainLimit.toString()),
                                ],
                              ),
                              VEmptyView(20),
                              Container(
                              ...
                              ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  return Dismissible(
                                    ...
                                    key: Key(
                                        model.aggDomains[index].id.toString()),
                              ...
                              Row(
                                children: [
                                  Text(tr("depend")),
                                  HEmptyView(5),
                                  Text(model.depDomains.length.toString()),
                                  Text("/"),
                                  Text(model.depDomainLimit.toString()),
                                ],
                              ),
                              VEmptyView(20),
                              Container(
                                ...
                                itemBuilder: (context, index) {
                                  return Dismissible(
                                    background: Container(
                                        color: Theme.of(context).accentColor),
                                    key: Key(
                                        model.depDomains[index].id.toString()),
                                    onDismissed: (direction) {
